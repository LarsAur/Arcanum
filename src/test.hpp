...
namespace ChessEngine2
{
    ...
    void runAllPerft()
    {
        ...
        sum += runPerft("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - ", 6, 8031647685LL);
        sum += runPerft("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - ", 7, 178633661LL);
